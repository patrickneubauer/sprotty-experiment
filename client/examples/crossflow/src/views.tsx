...
export class TaskNodeView extends CircularNodeView {
    render(node: TaskNode, context: RenderingContext): VNode {
        ...
        const fillColor = toSVG(rgb(253, 180, 98));
//        return <g>
...
export class SourceNodeView extends CircularNodeView {
    render(node: SourceNode, context: RenderingContext): VNode {
        const radius = this.getRadius(node);
        const fillColor = toSVG(rgb(253, 180, 98));
        return <g>
                <circle class-sprotty-node={true}
...
export class SinkNodeView extends CircularNodeView {
    render(node: SinkNode, context: RenderingContext): VNode {
        const radius = this.getRadius(node);
        const fillColor = toSVG(rgb(253, 180, 98));
        return <g>
                <circle class-sprotty-node={true}
...
export class CrossflowEdgeView extends PolylineEdgeView {
