...
public class DefaultDiagramServer implements IDiagramServer {
	...
	private boolean needsClientLayout = false;//true;
...
//		System.out.println("DefaultDiagramServer.submitModel: update=" + update + "; needsServerLayout=" + needsServerLayout(newRoot) + "; needsClientLayout=" + needsClientLayout(newRoot) );
////		System.out.println("; newRoot = " + newRoot.toString());
//		
////		if ( !newRoot.getType().equals("NONE") && !newRoot.getId().equals("ROOT") ) {
...
//	}
	...
	private void doSubmitModel(SModelRoot newRoot, boolean update) {
		System.out.println("DefaultDiagramServer.doSubmitModel with newRoot = ");
